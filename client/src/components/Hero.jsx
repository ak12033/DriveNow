...
const Hero = () => {
    ...
    return (
        ...
        className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
            ...
            <motion.form 
            initial={{y: 50, opacity: 0, scale: 0.95}} animate={{scale:1, y: 0, opacity: 1}} transition={{duration: 0.6, delay: 0.4}}
            ...
            bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
                <div className='flex flex-col md:flex-row items-start md:text-center gap-10 md:ml-8'>
            ...
            <motion.img initial={{y: 100, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{duration: 0.8, delay: 0.6}}
