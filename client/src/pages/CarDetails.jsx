    ...
    return car ? (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
                    ...
                    className='space-y-6'>
                        ...
                        <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                            {[
                                ...
                                key={text} className='flex flex-col items-center 
                                bg-light p-4 rounded-lg'>
                ...
                <motion.form initial={{y: 30, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 0.3}}
